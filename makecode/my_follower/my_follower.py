...
KD = 0.35            # 微分增益：阻尼（等效老師版 KD=350，與 KP=250 是他驗證過會順跑的組合）
                     # ⚠️ 這個刻度下每 +1 = 老師版 +1000，只動小數點；還抖就再降、過彎甩尾就加
SPEED_MAX = 400      # 直線基礎速度（先保守，確定不重開機再往上加）
...
FINISH_COUNT = 10     # 右側標記數到幾次停車（起點+終點 = 2）
# ============================================================
